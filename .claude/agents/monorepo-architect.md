...
description: "Expert in monorepo architecture, build systems (Nx, Turborepo, Bazel, Lerna), and dependency management at scale. Use for monorepo setup, build optimization, or scaling development workflows."
